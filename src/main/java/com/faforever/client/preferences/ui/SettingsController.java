...
public class SettingsController implements Controller<Node> {
  ...
  public void initialize() {
    ...
    autoChannelListView.setCellFactory(param -> new NodeListCell<>(channel -> {
      RemovableListCellController controller = uiService.loadFxml("theme/settings/removable_cell.fxml");
