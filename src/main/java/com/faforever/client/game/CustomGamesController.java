...
public class CustomGamesController extends AbstractViewController<Node> {
  ...
  public static final PseudoClass PSEUDO_CLASS_OPENED = PseudoClass.getPseudoClass("opened");
  public static final PseudoClass PSEUDO_CLASS_CLOSED = PseudoClass.getPseudoClass("closed");
